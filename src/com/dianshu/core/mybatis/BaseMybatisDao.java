package com.dianshu.core.mybatis;
...
import com.dianshu.core.mybatis.page.MysqlDialect;
...
//		LoggerUtils.fmtDebug(SELF, "findByPageBySqlId sql : %s",sqlcode );
		System.out.printf("findByPageBySqlId sql : %s",sqlcode);
...
//			LoggerUtils.error(SELF, "jdbc.error.code.findByPageBySqlId",e);
			System.out.printf("jdbc.error.code.findByPageBySqlId",e);
		}
		return page;
	}
...
//		LoggerUtils.fmtDebug(SELF, "findPage sql : %s",sqlcode );
		System.err.printf("findPage sql : %s",sqlcode);
		String countCode = "";
		BoundSql countSql = null;
