package com.dianshu.core.shiro.service.impl;
...
import com.dianshu.common.utils.INI4j;
import com.dianshu.core.shiro.service.ShiroManager;
/**
 * 
 * 
 * 动态加载权限 链
...
public class ShiroManagerImpl implements ShiroManager {
	...
	private String getFixedAuthRule(){
		...
		try {
			...
			System.out.printf( "加载文件出错。file:[%s]", fileName);
		}
...
//		ShiroFilterFactoryBean shiroFilterFactoryBean = (ShiroFilterFactoryBean) SpringContextUtil.getBean("shiroFilterFactoryBean");
		...
		try {
			...
			System.out.printf("getShiroFilter from shiroFilterFactoryBean error!", e);
